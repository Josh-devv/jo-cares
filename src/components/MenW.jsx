...
export default function MenW() {
    return(
        <div className="w-[100%] h-[100%] py-10 flex max-md:flex-col items-center">
            <div className="w-[60%] max-md:w-[100%]"><Image src={mw} alt="" className="w-[100%]" /></div>
            <div className="flex items-center max-md:justify-center max-md:flex-col max-md:w-[100%]">
               <div className="flex max-md:justify-center max-md:w-[100%]  flex-col max-md:flex-row">
                ...
                <div>
                   <p className="rounded-full flex justify-center items-center w-32 h-32 border border-black">COLLECTION</p> 
                </div>    
            </div>
        </div>
    )
