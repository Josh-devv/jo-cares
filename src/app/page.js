...
export default function Home() {
  ...
  return (
    ...
    <div className="grid grid-cols-2 max-sm:grid-cols-1 text-white">
          ...
          <div className="relative w-full">
            ...
            <div className="absolute top-1/3 w-3/4 max-lg:w-3/4">
                ...
                <button className=" bg-red-200 rounded-md bg-opacity-75 text-[1.2vw] p-2 max-md:text-[1.8vw] max-sm:mt-3">SHOP NOW</button>
                </div>
              </div>
          </div>
          ...
          <div className="">
            <div className="relative">
              ...
              <div className="absolute top-0 w-3/4">
                ...
                <button className=" bg-red-200 rounded-md bg-opacity-75 bg-none text-[1.2vw] p-2 max-md:text-[1.8vw]">SHOP NOW</button>
                </div>
              </div>
            </div>
    ...
    <div className="w-full py-8 ">
      <div className="flex w-full relative justify-center items-center max-md:hidden">
        <div className="w-10/12 flex justify-center items-center">
          <h1 className="absolute text-white text-[5vw] w-40 h-40 self-start justify-self-start" style={{fontFamily:'itl'}}><span className="line-through">25%</span> NOW 50% OFF</h1>
          <Image src={col} className="w-[60%] "/>
        </div>

        <div className="w-11/12">
          <h1 className="text-[5vw] max-md:text-[4vw]">SUMMER COLLECTION</h1>
          <p className="w-[90%] text-slate-400 text-[13px] max-md:text-[10px]">Dignissim lacus, turpis ut suspendisse vel tellus.
             Turpis purus, gravida orci, fringilla a. Ac sed eu
              fringilla odio mi. Consequat pharetra at magna 
              imperdiet cursus ac faucibus sit libero. Ultricies 
              quam nunc, lorem sit lorem urna, pretium aliquam ut.
               In vel, quis donec dolor id in. Pulvinar commodo mollis 
               diam sed facilisis at cursus imperdiet cursus ac faucibus 
               sit faucibus sit libero.
          </p>
          <button className="border-2 border-black font-medium mt-4 p-2">SHOP COLLECTION</button>
        </div>
      </div>
    </div>
    </div>
